###########################################################################
## Makefile generated for component 'Hardware_Hidden_Symulink'. 
## 
## Makefile     : Hardware_Hidden_Symulink.mk
## Generated on : Sat Nov 26 13:10:29 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Hardware_Hidden_Symulink.elf
...
PRODUCT_NAME              = Hardware_Hidden_Symulink
MAKEFILE                  = Hardware_Hidden_Symulink.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/personal/School/MCMAST~1/TRONII~2/SOFTWA~1/PACEMA~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Hardware_Hidden_Symulink_comp.rsp
CMD_FILE                  = Hardware_Hidden_Symulink.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Hardware_Hidden_Symulink.elf
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=19 -DMW_SERIAL0_TXBUF_SIZE=88 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=Hardware_Hidden_Symulink -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o i2c_api.o MW_I2C.o MW_SCI.o MW_AnalogInput.o Hardware_Hidden_Symulink.o Hardware_Hidden_Symulink_data.o send_param.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Hardware_Hidden_Symulink_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Hardware_Hidden_Symulink_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Hardware_Hidden_Symulink_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Hardware_Hidden_Symulink_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Hardware_Hidden_Symulink_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Hardware_Hidden_Symulink_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Hardware_Hidden_Symulink.o : $(START_DIR)/Hardware_Hidden_Symulink_ert_rtw/Hardware_Hidden_Symulink.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Hardware_Hidden_Symulink_data.o : $(START_DIR)/Hardware_Hidden_Symulink_ert_rtw/Hardware_Hidden_Symulink_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


send_param.o : $(START_DIR)/Hardware_Hidden_Symulink_ert_rtw/send_param.c
	$(CC) $(CFLAGS) -o "$@" "$<"
