###########################################################################
## Makefile generated for component 'pacemakerA1'. 
## 
## Makefile     : pacemakerA1.mk
## Generated on : Mon Oct 17 15:05:04 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pacemakerA1.elf
...
PRODUCT_NAME              = pacemakerA1
MAKEFILE                  = pacemakerA1.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/eddys/OneDrive/MCMAST~1/TRONII~1/SOFTWA~1/PACEMA~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = pacemakerA1_comp.rsp
CMD_FILE                  = pacemakerA1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pacemakerA1.elf
...
DEFINES_STANDARD = -DMODEL=pacemakerA1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o pacemakerA1.o pacemakerA1_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/pacemakerA1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pacemakerA1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pacemakerA1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pacemakerA1_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pacemakerA1_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/pacemakerA1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pacemakerA1.o : $(START_DIR)/pacemakerA1_ert_rtw/pacemakerA1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pacemakerA1_data.o : $(START_DIR)/pacemakerA1_ert_rtw/pacemakerA1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
